...
<?php	for ($i=1; $i<$numberFields; $i++):	?>
	...
	<tr><td><label for=""><?php	echo $arrOfHeaders[$i-1]	?></label></td>
<td><input type="text" name="stringOfValues[]" value="<?php	if (isset($_POST['editButton']) and $_POST['editButton']=='Редактировать') {
